        ...
        <ScrollView contentContainerStyle={{ flexGrow: 1, backgroundColor: 'white' }}>
            ...
            <ImageBackground source={ImagePath.Explore} style={{ flex: 1 }}>
                ...
                <LinearGradient style={{ flex: 1, justifyContent: "flex-end" }} start={{ x: 0, y: 0 }} end={{ x: 0, y: 1 }}
                    ...
                    <View style={{}}>
                        <Text style={{ fontFamily: "Metropolis-Bold", fontSize: hp(3), paddingHorizontal: 35, textAlign: 'center', lineHeight: 30, color: '#000000' }}>Discover your new favorite club in just seconds.</Text>
                        <Text style={{ fontWeight: '400', fontSize: 15, paddingHorizontal: 30, textAlign: 'center', lineHeight: 18, marginTop: 10, color: '#000000' }}>Explore new clubs and events near you and make unforgettable memories with just one tap.</Text>
